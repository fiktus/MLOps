...
class ItemFeatures(Base):
    ...
    __table_args__ = (
        CheckConstraint("historical_return_rate >= 0 AND historical_return_rate <= 1", "historical_rate_range"),
        CheckConstraint("avg_item_losses_30d >= 0", "avg_item_loss_positive"),
    )
